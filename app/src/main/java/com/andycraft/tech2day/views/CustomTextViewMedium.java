...
public class CustomTextViewMedium extends TextView {
    ...
    private void setCustomFont(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomTextViewMedium);
        String customFont = a.getString(R.styleable.CustomTextViewMedium_CustomTextViewMediumCustomFont);
    ...
    private boolean setCustomFont(Context ctx, String asset) {
        try {
            Typeface tf;
            tf = Typeface.createFromAsset(ctx.getAssets(), "fonts/Roboto-Medium.ttf");
