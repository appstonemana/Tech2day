...
public class CustomTextViewRegular extends TextView {
    ...
    private void setCustomFont(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomTextViewRegular);
        String customFont = a.getString(R.styleable.CustomTextViewRegular_CustomTextViewRegularCustomFont);
